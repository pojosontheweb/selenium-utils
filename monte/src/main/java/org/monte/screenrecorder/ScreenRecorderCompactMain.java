...
public class ScreenRecorderCompactMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        formatAviItem = new JRadioButtonMenuItem();
        formatQuicktimeItem = new JRadioButtonMenuItem();
        jSeparator4 = new javax.swing.JPopupMenu.Separator();
        areaScreenItem = new JRadioButtonMenuItem();
        areaCustomItem = new JRadioButtonMenuItem();
        jSeparator1 = new javax.swing.JPopupMenu.Separator();
        videoMenu = new javax.swing.JMenu();
        colorMillionsItem = new JRadioButtonMenuItem();
        colorThousandsItem = new JRadioButtonMenuItem();
        jSeparator5 = new javax.swing.JPopupMenu.Separator();
        fps20Item = new JRadioButtonMenuItem();
        fps10Item = new JRadioButtonMenuItem();
        jSeparator3 = new javax.swing.JPopupMenu.Separator();
        cursorBlackItem = new JRadioButtonMenuItem();
        cursorWhiteItem = new JRadioButtonMenuItem();
        cursoYellowItem = new JRadioButtonMenuItem();
        cursorNoneItem = new JRadioButtonMenuItem();
        audioMenu = new javax.swing.JMenu();
        jSeparator2 = new javax.swing.JPopupMenu.Separator();
        audio44kHzItem = new JRadioButtonMenuItem();
        audio22kHzItem = new JRadioButtonMenuItem();
        jSeparator6 = new javax.swing.JPopupMenu.Separator();
        monoItem = new JRadioButtonMenuItem();
        stereoItem = new JRadioButtonMenuItem();
        formatGroup = new ButtonGroup();
        areaGroup = new ButtonGroup();
        colorGroup = new ButtonGroup();
        audioRateGroup = new ButtonGroup();
        cursorGroup = new ButtonGroup();
        fpsGroup = new ButtonGroup();
        channelsGroup = new ButtonGroup();
        audioSourceGroup = new ButtonGroup();
        ...
        audioMonitor.setForeground(new Color(255, 255, 255));
    ...
    private void optionsPerformed(ActionEvent evt) {//GEN-FIRST:event_optionsPerformed
