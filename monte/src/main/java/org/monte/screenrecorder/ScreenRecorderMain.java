...
public class ScreenRecorderMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        formatChoice.setModel(new DefaultComboBoxModel(new String[] { "AVI", "QuickTime" }));
        formatChoice.addActionListener(formListener);

        colorsLabel.setText("Colors:");

        colorsChoice.setModel(new DefaultComboBoxModel(new String[] { "Hundreds", "Thousands", "Millions" }));
        ...
        cursorChoice.setModel(new DefaultComboBoxModel(new String[] { "No Cursor", "Black Cursor", "White Cursor" }));

        audioRateLabel.setText("Audio Rate:");

        audioRateChoice.setModel(new DefaultComboBoxModel(new String[] { "44.100 kHz" }));
        ...
        encodingChoice.setModel(new DefaultComboBoxModel(new String[] { "Screen Capture", "Run Length", "None", "PNG", "JPEG 100 %", "JPEG   50 %" }));

        areaLabel.setText("Area:");

        areaChoice.setModel(new DefaultComboBoxModel(new String[] { "Entire Screen", "0 0,  1024 x 768", " " }));
        ...
        audioSourceChoice.setModel(new DefaultComboBoxModel(new String[] { "No Audio", "44.100 kHz" }));
        ...
        layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {audioRateChoice, colorsChoice, cursorChoice, formatChoice});
        ...
        switch (formatChoice.getSelectedIndex()) {
            case 0: // AVI
                encodingChoice.setModel(
                        new DefaultComboBoxModel(new String[]{"Screen Capture", "Run Length", "None", "PNG", "JPEG 100 %", "JPEG  50 %"}));
                break;
            case 1: // QuickTime
                encodingChoice.setModel(
                        new DefaultComboBoxModel(new String[]{"Screen Capture", "Animation", "None", "PNG", "JPEG 100 %", "JPEG  50 %"}));
                break;
        }
        encodingChoice.setSelectedIndex(index);
    }

    private void startStopPerformed(ActionEvent evt) {//GEN-FIRST:event_startStopPerformed
        if (screenRecorder == null) {
    ...
    private void formatChoicePerformed(ActionEvent evt) {//GEN-FIRST:event_formatChoicePerformed
        updateEncodingChoice();
    }//GEN-LAST:event_formatChoicePerformed

    private void selectAreaPerformed(ActionEvent evt) {//GEN-FIRST:event_selectAreaPerformed
