...
public class MP3AudioInputStream extends AudioInputStream {
     ...
     *
     * @param file A File.
     * @throws java.io.IOException if the file does not contain an MP3 elementary stream.
     */
     ...
     * @throws java.io.IOException if the stream does not contain an MP3 elementary stream.
     */
