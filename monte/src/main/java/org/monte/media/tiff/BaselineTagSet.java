    ...
    public static BaselineTagSet getInstance() {
        if (instance == null) {
            TIFFTag[] tags = {
                ...
                new TIFFTag("SubfileType", 0xff, SHORT_MASK, new EnumValueFormatter(
                ...
                new TIFFTag("FillOrder", 0x10a, SHORT_MASK, new EnumValueFormatter(
                "bigEndian", 1,
                "littleEndian", 2
                )),
                ...
                new TIFFTag("EXIF", TAG_EXIF, IFD_MASK | LONG_MASK), 
                new TIFFTag("GPS", TAG_GPS, IFD_MASK | LONG_MASK), 
                new TIFFTag("Interoperability", TAG_Interoperability, IFD_MASK | LONG_MASK), 
            };
